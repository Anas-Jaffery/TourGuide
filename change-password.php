...
<html>
<head>
<title>TTG | THE TOUR GUIDE</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="THE TOUR GUIDE In PHP" />
...
{
alert("New Password and Confirm Password Field dOESN'T match  !!");
...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">TTG - THE TOUR GUIDE</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
